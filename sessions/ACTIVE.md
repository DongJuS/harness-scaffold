...
HarnessScaffold project. Each session registers here on start and updates
its status on completion. This enables multiple concurrent AI or developer
sessions to coordinate and avoid conflicting work.
